        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    SuperAlbum.createAlbum(PlaceholderFragment.this, true,
                            GlideEngine.getInstance()).setFileProviderAuthority("com.StrivingRookies" +
                            ".superalbum.ui_menu.fileprovider").start(0);
                }
            });
